...
<div class="logo" style="display: flex;align-items: center;">
    ...
    <ul class="nav-links nav">
        <li><a id="accueil-link" class="nav-item" active-color="#ffeba7" href="http://localhost:8888/php/car_auction/views/login.php">Accueil</a></li>
        ...
        <li><a class="login-button" href="http://localhost:8888/php/car_auction/views/login.php">Se connecter</a></li>
    </ul>
</nav>
<script>
