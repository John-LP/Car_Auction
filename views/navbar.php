...
<nav>
    ...
    <ul class="nav-links nav">
        ...
        <li><a id="enchere-acheteur-link" class="nav-item" active-color="#ffeba7" href="http://localhost/exoPHP/car_auction/views/encheres_acheteur.php">Mes acquisitions</a></li>
